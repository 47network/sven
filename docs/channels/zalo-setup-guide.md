# zalo Channel Setup Guide

Date: 2026-02-21

## Scope

This guide covers baseline setup for services/adapter-zalo.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for zalo.
...
3. Ensure egress/network policy allows the zalo platform endpoint.

## Bring-up

1. Start adapter-zalo with the rest of services.
