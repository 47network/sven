# webchat Channel Setup Guide

Date: 2026-02-21

## Scope

This guide covers baseline setup for services/adapter-webchat.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for webchat.
...
3. Ensure egress/network policy allows the webchat platform endpoint.

## Bring-up

1. Start adapter-webchat with the rest of services.
