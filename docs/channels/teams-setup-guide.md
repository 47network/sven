...
This guide covers baseline setup for services/adapter-teams.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for teams.
...
3. Ensure egress/network policy allows the teams platform endpoint.

## Bring-up

1. Start adapter-teams with the rest of services.
