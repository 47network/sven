# tlon Channel Setup Guide

Date: 2026-02-21

## Scope

This guide covers baseline setup for services/adapter-tlon.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for tlon.
...
3. Ensure egress/network policy allows the tlon platform endpoint.

## Bring-up

1. Start adapter-tlon with the rest of services.
