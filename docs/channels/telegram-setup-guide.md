...
This guide covers baseline setup for services/adapter-telegram.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for telegram.
...
3. Ensure egress/network policy allows the telegram platform endpoint.

## Bring-up

1. Start adapter-telegram with the rest of services.
