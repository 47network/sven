# imessage Channel Setup Guide

Date: 2026-02-21

## Scope

This guide covers baseline setup for services/adapter-imessage.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for imessage.
...
3. Ensure egress/network policy allows the imessage platform endpoint.

## Bring-up

1. Start adapter-imessage with the rest of services.
