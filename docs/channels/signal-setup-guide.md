# signal Channel Setup Guide

Date: 2026-02-21

## Scope

This guide covers baseline setup for services/adapter-signal.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for signal.
...
3. Ensure egress/network policy allows the signal platform endpoint.

## Bring-up

1. Start adapter-signal with the rest of services.
