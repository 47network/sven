...
This guide covers baseline setup for services/adapter-feishu.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for feishu.
...
3. Ensure egress/network policy allows the feishu platform endpoint.

## Bring-up

1. Start adapter-feishu with the rest of services.
