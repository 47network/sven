# voice-call Channel Setup Guide

Date: 2026-02-21

## Scope

This guide covers baseline setup for services/adapter-voice-call.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for voice-call.
...
3. Ensure egress/network policy allows the voice-call platform endpoint.

## Bring-up

1. Start adapter-voice-call with the rest of services.
