...
This guide covers baseline setup for services/adapter-line.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for line.
...
3. Ensure egress/network policy allows the line platform endpoint.

## Bring-up

1. Start adapter-line with the rest of services.
