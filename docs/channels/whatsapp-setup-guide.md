...
This guide covers baseline setup for services/adapter-whatsapp.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for whatsapp.
...
3. Ensure egress/network policy allows the whatsapp platform endpoint.

## Bring-up

1. Start adapter-whatsapp with the rest of services.
