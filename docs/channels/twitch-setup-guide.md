# twitch Channel Setup Guide

Date: 2026-02-21

## Scope

This guide covers baseline setup for services/adapter-twitch.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for twitch.
...
3. Ensure egress/network policy allows the twitch platform endpoint.

## Bring-up

1. Start adapter-twitch with the rest of services.
