...
This guide covers baseline setup for services/adapter-discord.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for discord.
...
3. Ensure egress/network policy allows the discord platform endpoint.

## Bring-up

1. Start adapter-discord with the rest of services.
