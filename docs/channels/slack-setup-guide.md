...
This guide covers baseline setup for services/adapter-slack.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for slack.
...
3. Ensure egress/network policy allows the slack platform endpoint.

## Bring-up

1. Start adapter-slack with the rest of services.
