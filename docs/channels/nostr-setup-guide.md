# nostr Channel Setup Guide

Date: 2026-02-21

## Scope

This guide covers baseline setup for services/adapter-nostr.

## Prerequisites

- Sven core stack running (gateway-api, agent-runtime, nats, postgres).
- Channel credentials/tokens provisioned for nostr.
...
3. Ensure egress/network policy allows the nostr platform endpoint.

## Bring-up

1. Start adapter-nostr with the rest of services.
