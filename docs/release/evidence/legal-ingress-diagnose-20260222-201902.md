...
Timestamp: 2026-02-22T20:19:02.9872125+02:00
...
timestamp=2026-02-22T20:19:04+02:00
------------------------------------------------------------
DNS resolution
...
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.019388s
curl -I https://sven.example.com/
curl: (28) Connection timed out after 8008 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.008108s
curl -I http://app.sven.example.com/
curl: (28) Connection timed out after 8018 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.018619s
curl -I https://app.sven.example.com/
curl: (28) Connection timed out after 8023 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.023883s
curl -I https://app.sven.example.com/healthz
curl: (28) Connection timed out after 8012 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.012121s
curl -I https://app.sven.example.com/readyz
curl: (28) Connection timed out after 8010 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.010559s
curl -I https://app.sven.example.com/privacy
curl: (28) Connection timed out after 8020 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.019205s
curl -I https://app.sven.example.com/terms
curl: (28) Connection timed out after 8019 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.019585s
------------------------------------------------------------
