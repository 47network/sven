...
Timestamp: 2026-02-22T03:12:57.3911265+02:00
...
timestamp=2026-02-22T03:12:57+02:00
------------------------------------------------------------
DNS resolution
...
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.032922s
curl -I https://sven.example.com/
curl: (28) Connection timed out after 8028 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.028813s
curl -I http://app.sven.example.com/
curl: (28) Connection timed out after 8036 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.036033s
curl -I https://app.sven.example.com/
curl: (28) Connection timed out after 8027 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.027092s
curl -I https://app.sven.example.com/healthz
curl: (28) Connection timed out after 8030 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.030897s
curl -I https://app.sven.example.com/readyz
curl: (28) Connection timed out after 8031 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.031094s
curl -I https://app.sven.example.com/privacy
curl: (28) Connection timed out after 8027 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.027233s
curl -I https://app.sven.example.com/terms
curl: (28) Connection timed out after 8034 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.034325s
------------------------------------------------------------
