...
Timestamp: 2026-02-22T04:30:36.1125700+02:00
...
timestamp=2026-02-22T04:30:35+02:00
------------------------------------------------------------
DNS resolution
...
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.033995s
curl -I https://sven.example.com/
curl: (28) Connection timed out after 8033 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.033427s
curl -I http://app.sven.example.com/
curl: (28) Connection timed out after 8030 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.030677s
curl -I https://app.sven.example.com/
curl: (28) Connection timed out after 8029 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.029393s
curl -I https://app.sven.example.com/healthz
curl: (28) Connection timed out after 8029 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.029788s
curl -I https://app.sven.example.com/readyz
curl: (28) Connection timed out after 8033 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.033558s
curl -I https://app.sven.example.com/privacy
curl: (28) Connection timed out after 8031 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.031139s
curl -I https://app.sven.example.com/terms
curl: (28) Connection timed out after 8033 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.033077s
------------------------------------------------------------
