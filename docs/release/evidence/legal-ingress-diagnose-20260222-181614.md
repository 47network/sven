...
Timestamp: 2026-02-22T18:16:14.0202306+02:00
...
timestamp=2026-02-22T18:16:15+02:00
------------------------------------------------------------
DNS resolution
...
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.017210s
...
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.011041s
curl -I https://app.sven.example.com/
curl: (28) Connection timed out after 8008 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.008300s
curl -I https://app.sven.example.com/healthz
curl: (28) Connection timed out after 8008 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.008092s
curl -I https://app.sven.example.com/readyz
curl: (28) Connection timed out after 8010 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.010120s
curl -I https://app.sven.example.com/privacy
curl: (28) Connection timed out after 8010 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.010754s
curl -I https://app.sven.example.com/terms
curl: (28) Connection timed out after 8010 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.010487s
------------------------------------------------------------
