...
- Generated: 2026-02-23T08:04:46.447Z
- Result: FAIL
- Auto-start IdP: no
...
```text
[sso:keycloak] failed: create account failed (403) body={"success":false,"error":{"code":"ORG_REQUIRED","message":"Active account required","details":null}}
```
