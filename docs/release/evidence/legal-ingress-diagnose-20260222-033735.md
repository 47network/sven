...
Timestamp: 2026-02-22T03:37:35.0263531+02:00
...
timestamp=2026-02-22T03:37:35+02:00
------------------------------------------------------------
DNS resolution
...
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.036237s
curl -I https://sven.example.com/
curl: (28) Connection timed out after 8032 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.032291s
curl -I http://app.sven.example.com/
curl: (28) Connection timed out after 8035 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.035643s
curl -I https://app.sven.example.com/
curl: (28) Connection timed out after 8035 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.035859s
curl -I https://app.sven.example.com/healthz
curl: (28) Connection timed out after 8033 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.033879s
curl -I https://app.sven.example.com/readyz
curl: (28) Connection timed out after 8035 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.035469s
curl -I https://app.sven.example.com/privacy
curl: (28) Connection timed out after 8035 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.035896s
curl -I https://app.sven.example.com/terms
curl: (28) Connection timed out after 8029 milliseconds
status=000 remote_ip= connect=0.000000s appconnect=0.000000s total=8.029205s
------------------------------------------------------------
