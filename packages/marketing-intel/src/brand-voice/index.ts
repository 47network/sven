...
export function checkBrandVoice(
  ...
  const suggestions = generateSuggestions(toneAnalysis, keyMessageCoverage);
...
function generateSuggestions(toneAnalysis: ToneScore[], keyMessageCoverage: KeyMessageHit[]): string[] {
