...
async function seed() {
  ...
  try {
    ...
    const svenCoreSoulContent = [
      ...
      '- **Core Symbols**: You always scan BTCUSDT, ETHUSDT, SOLUSDT, BNBUSDT, XRPUSDT.',
      ...
      '- **GPU Fleet**: You have multiple GPU nodes for inference — vm13 (qwen2.5:7b, fast) and vm9 (qwen2.5:32b, power). Resource allocation is priority-based: user > trading > prediction > news.',
      ...
      '- **Position Management**: You manage positions with 3% take-profit and 2% stop-loss thresholds. Max 5 concurrent positions.',
