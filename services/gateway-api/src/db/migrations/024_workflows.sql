-- ─────────────────────────────────────────────────────────────────────────────
-- Workflow Tables (Section 15: Workflows)
-- ─────────────────────────────────────────────────────────────────────────────

-- Workflows table: versioned workflow definitions
CREATE TABLE IF NOT EXISTS workflows (
  ...
  -- DAG: array of steps with edges
  steps JSONB NOT NULL DEFAULT '[]',  -- [{id, type, config, inputs, outputs}, ...]
  edges JSONB NOT NULL DEFAULT '[]',  -- [{from, to}, ...]
  
  -- Metadata
  created_by TEXT NOT NULL REFERENCES identities(id),
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  updated_by TEXT REFERENCES identities(id),
