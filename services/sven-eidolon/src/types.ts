...
export type EidolonBuildingKind =
  ...
  | 'compliance_scanner'
  | 'backup_vault'
  | 'traffic_shaper' | 'service_mesh' | 'wan_optimizer' | 'link_aggregator' | 'protocol_gateway' | 'vlan_manager'
  | 'log_rotator'
  | 'ip_gatekeeper'
  | 'webhook_relay'
  | 'storage_tower'
