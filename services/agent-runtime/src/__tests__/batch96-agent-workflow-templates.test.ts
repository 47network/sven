...
describe('Batch 96 — Agent Workflow Templates', () => {
  ...
  describe('Shared types', () => {
    ...
    it('exports WftTriggerType', () => { expect(src).toContain("export type WftTriggerType"); });
    it('exports ExecutionStatus', () => { expect(src).toContain("export type ExecutionStatus"); });
    it('exports WftWorkflowTemplate interface', () => { expect(src).toContain("export interface WftWorkflowTemplate"); });
