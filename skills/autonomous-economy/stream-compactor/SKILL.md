...
description: Stream log compaction with segment scanning tombstone collapsing and atomic compacted log persistence
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Stream log compaction with segment scanning tombstone collapsing and atomic compacted log persistence.
