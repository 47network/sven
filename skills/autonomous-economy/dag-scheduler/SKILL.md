---
name: dag-scheduler
description: DAG-based workflow scheduling with node execution tracking and failure handling
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
DAG-based workflow scheduling with node execution tracking and failure handling.
