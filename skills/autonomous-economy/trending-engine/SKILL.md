...
description: Trending engine with event aggregation velocity computation trend emergence and rolling time windows
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Trending engine with event aggregation velocity computation trend emergence and rolling time windows.
