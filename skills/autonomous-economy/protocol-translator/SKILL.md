...
description: Protocol translation between AMQP MQTT HTTP and gRPC with parsing mapping payload emission and error handling
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Protocol translation between AMQP MQTT HTTP and gRPC with parsing mapping payload emission and error handling.
