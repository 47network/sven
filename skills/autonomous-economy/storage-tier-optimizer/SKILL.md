...
description: Storage tier optimization with access pattern analysis candidate selection cold-storage transition and savings reporting
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Storage tier optimization with access pattern analysis candidate selection cold-storage transition and savings reporting.
