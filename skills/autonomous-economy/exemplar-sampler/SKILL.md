---
name: exemplar-sampler
description: Trace exemplar sampling for metric-to-trace correlation
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Trace exemplar sampling for metric-to-trace correlation.
...
- `targetId` — ID of the target to monitor
