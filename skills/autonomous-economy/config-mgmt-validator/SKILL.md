---
name: config-mgmt-validator
description: Configuration validation with allowlist schema validation results emission and audit recording
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Configuration validation with allowlist schema validation results emission and audit recording.
