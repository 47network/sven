---
name: load-balancer-traffic-router
description: Routes traffic across load balancer targets
version: 1.0.0
pricing: 0.99
archetype: analyst
---

# LoadBalancerTrafficRouter

Routes traffic across load balancer targets.
