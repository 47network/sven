---
name: service-mesh-observability-agent
description: Collects distributed tracing and metrics from the service mesh
version: 1.0.0
pricing: 0.99
archetype: analyst
---

# ServiceMeshObservabilityAgent

Collects distributed tracing and metrics from the service mesh.
