...
description: Batch ETL job execution with scheduling transformation loading and lineage recording
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Batch ETL job execution with scheduling transformation loading and lineage recording.
