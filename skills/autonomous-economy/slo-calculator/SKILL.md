---
name: slo-calculator
description: SLO calculation with error budget tracking burn rate alerting and rolling window evaluation
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
SLO calculation with error budget tracking burn rate alerting and rolling window evaluation.
