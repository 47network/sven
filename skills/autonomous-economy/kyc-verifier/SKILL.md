---
name: kyc-verifier
description: KYC verification with identity intake document validation liveness checks and verdict issuance under audit
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
KYC verification with identity intake document validation liveness checks and verdict issuance under audit.
