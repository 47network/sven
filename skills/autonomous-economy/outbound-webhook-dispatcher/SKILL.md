...
description: Outbound webhook dispatch with queueing endpoint invocation response handling and delivery recording
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Outbound webhook dispatch with queueing endpoint invocation response handling and delivery recording.
