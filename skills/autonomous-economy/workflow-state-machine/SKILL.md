...
description: Workflow state machine engine with transition execution guard evaluation and termination handling
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Workflow state machine engine with transition execution guard evaluation and termination handling.
