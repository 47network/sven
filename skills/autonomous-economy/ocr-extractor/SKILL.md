---
name: ocr-extractor
description: OCR text extraction with region detection multi-language extraction and per-region confidence reporting
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
OCR text extraction with region detection multi-language extraction and per-region confidence reporting.
