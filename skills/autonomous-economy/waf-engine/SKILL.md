---
name: waf-engine
description: Web application firewall engine with rule management request blocking signature updates and bypass detection
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Web application firewall engine with rule management request blocking signature updates and bypass detection.
