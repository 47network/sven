---
name: sms-dispatcher
description: SMS dispatch with validation carrier routing send execution and delivery receipt recording
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
SMS dispatch with validation carrier routing send execution and delivery receipt recording.
