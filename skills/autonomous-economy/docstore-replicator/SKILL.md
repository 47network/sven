---
name: docstore-replicator
description: Document store replication with change stream application lag reporting and audit recording
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Document store replication with change stream application lag reporting and audit recording.
