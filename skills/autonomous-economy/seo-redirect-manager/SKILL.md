---
name: seo-redirect-manager
description: SEO redirect management with rule receipt loop detection persistence and edge cache invalidation
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
SEO redirect management with rule receipt loop detection persistence and edge cache invalidation.
