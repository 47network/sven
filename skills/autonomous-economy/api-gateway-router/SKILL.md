...
description: API gateway routing with policy application upstream proxying and failure handling
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
API gateway routing with policy application upstream proxying and failure handling.
