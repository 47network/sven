---
name: cluster-node-provisioner
description: Provisions and decommissions cluster nodes based on demand
version: 1.0.0
pricing: 0.99
archetype: analyst
---

# ClusterNodeProvisioner

Provisions and decommissions cluster nodes based on demand.
