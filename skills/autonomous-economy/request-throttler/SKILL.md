...
description: Request throttling with token bucket budget evaluation consumption and rolling-window resets
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Request throttling with token bucket budget evaluation consumption and rolling-window resets.
