...
description: CI/CD build pipeline orchestration with multi-stage runs artifact publication and failure reporting
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
CI/CD build pipeline orchestration with multi-stage runs artifact publication and failure reporting.
