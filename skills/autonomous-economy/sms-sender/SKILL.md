---
name: sms-sender
description: SMS sending with opt-in verification carrier dispatch retry handling and acknowledgement recording
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
SMS sending with opt-in verification carrier dispatch retry handling and acknowledgement recording.
