...
description: DNS health probing with scheduled target execution result evaluation and status recording for failover decisions
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
DNS health probing with scheduled target execution result evaluation and status recording for failover decisions.
