---
name: lake-compactor
description: Lake compaction with file scanning safe merge of small files and atomic manifest commit
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Lake compaction with file scanning safe merge of small files and atomic manifest commit.
