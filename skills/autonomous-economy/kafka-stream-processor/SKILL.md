...
description: Kafka stream processing with topic subscription offset commits and dead-letter queue dispatch
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Kafka stream processing with topic subscription offset commits and dead-letter queue dispatch.
