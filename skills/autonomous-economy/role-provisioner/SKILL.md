...
description: Role-based access control provisioning with policy sync and time-bounded assignments
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Role-based access control provisioning with policy sync and time-bounded assignments.
