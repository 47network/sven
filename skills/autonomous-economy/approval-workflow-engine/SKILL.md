...
description: Approval workflow engine with case creation step advancement approver notification and finalization
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Approval workflow engine with case creation step advancement approver notification and finalization.
