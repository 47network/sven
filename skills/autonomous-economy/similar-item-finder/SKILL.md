---
name: similar-item-finder
description: Similar item finding with candidate set building similarity scoring filtering and result caching
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Similar item finding with candidate set building similarity scoring filtering and result caching.
