...
description: Digest summarization with event aggregation summary composition formatting and digest emission per cadence
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Digest summarization with event aggregation summary composition formatting and digest emission per cadence.
