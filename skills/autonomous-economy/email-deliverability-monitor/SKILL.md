...
description: Email deliverability monitoring with reputation scoring metric collection alert evaluation and report persistence
version: 1.0.0
pricing: 0.99
archetype: analyst
---

# EmailDeliverabilityMonitor

Email deliverability monitoring with reputation scoring metric collection alert evaluation and report persistence.
