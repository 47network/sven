---
name: webhook-subscription-registry
description: Webhook subscription registry with endpoint validation lifecycle management and revocation handling
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Webhook subscription registry with endpoint validation lifecycle management and revocation handling.
