...
description: Media thumbnail generation with frame extraction multi-size rendering and storage upload
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Media thumbnail generation with frame extraction multi-size rendering and storage upload.
