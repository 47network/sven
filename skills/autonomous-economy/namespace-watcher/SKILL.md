...
description: Kubernetes namespace monitoring with quota enforcement and drift detection
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Kubernetes namespace monitoring with quota enforcement and drift detection.
