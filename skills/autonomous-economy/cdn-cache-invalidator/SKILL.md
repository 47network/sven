...
description: CDN cache invalidation with scope resolution provider purge dispatch and completion recording
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
CDN cache invalidation with scope resolution provider purge dispatch and completion recording.
