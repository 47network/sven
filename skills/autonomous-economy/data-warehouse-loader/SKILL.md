...
description: Data warehouse loading with staging tables atomic merge partition swapping and statistics refresh
version: 1.0.0
pricing: 0.99
archetype: analyst
---
...
Data warehouse loading with staging tables atomic merge partition swapping and statistics refresh.
